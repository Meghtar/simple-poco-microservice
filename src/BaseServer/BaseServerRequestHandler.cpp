...
std::string
BaseServerRequestHandler::createUrl(const std::string& protocol,
...
void
BaseServerRequestHandler::handleRequest(Poco::Net::HTTPServerRequest& request,
                                        Poco::Net::HTTPServerResponse& response)
{
  ...
  const std::string responseText =
    _useRemote ? prepareResponse(request, externalResponse)
               : prepareResponse(request, defaultText);
...
std::string
BaseServerRequestHandler::getRequestContent(
...
std::string
BaseServerRequestHandler::sendRequest(
  std::string url,
  std::string body,
...
std::string
BaseServerRequestHandler::prepareResponse(
